  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      seeking a fresher role as a Frontend or React developer. I have a Diploma in Computer Science Engineering (2018-2021)
       ...
       I've completed the 'Namaste React' course and built projects like Interactive DSA Coding Platform, AI-powered Product Suggestions,Movie Suggestion Platform, Video Streaming Platform, Food Ordering Web Application, Google Theme Portfolio.
